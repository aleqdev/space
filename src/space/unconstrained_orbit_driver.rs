...
impl Default for UnconstrainedOrbit {
    fn default() -> Self {
        Self::new()
    }
}
...
impl UnconstrainedOrbit {
    ...
    pub fn rotate_yaw_pitch(&mut self, yaw_degrees: f32, pitch_degrees: f32) {
        ...
        self.pitch_degrees = (self.pitch_degrees + pitch_degrees) % 720_f32;
    }
...
impl<H: Handedness> RigDriver<H> for UnconstrainedOrbit {
...
*/
pub type UnconstrainedOrbit = bevy_dolly::prelude::YawPitch;
