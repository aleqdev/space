pub mod systems {
    ...
    use crate::space::{
        ...
        scene::{SelectionRaycastSet, SelectionTargetRedirect},
    };
    ...
    pub fn spawn_nasa_body(
        ...
        for response in ev.iter() {
            ...
            let mut add_polyline_entity =
                |commands: &mut Commands, polyline, mut color: Color, name: String| {
                    color.set_a(0.1);
            ...
            add_polyline_entity(&mut commands, polyline, Color::GRAY, response.name.clone());
            ...
            commands
                .spawn((
                    ...
                    SpatialBundle {
                        transform: Transform::from_translation(Vec3::new(
                            (response.position.x * camera_scale.scale) as f32,
                            (response.position.y * camera_scale.scale) as f32,
                            (response.position.z * camera_scale.scale) as f32,
                        )),
                        ..default()
                    },
                ))
                .with_children(|anchor| {
                    ...
                    anchor.spawn((
                        MaterialMeshBundle {
                            ...
                            transform: Transform::from_scale(Vec3::splat(
                                (response.radius * camera_scale.scale) as f32,
                            )),
                            ..default()
                        },
                    ...
                    if let SpaceBodyKnownDetailsMaterial::Star(star_material) = &response.material {
                        anchor.spawn((
                            MaterialMeshBundle {
                                mesh: uv_sphere(),
